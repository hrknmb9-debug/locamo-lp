...
export default function Contact() {
  const faqs = [
    ...
    {
      q: '個人店ですが、LPだけで足りますか？',
      a: '多くの個人店では一枚のLPで「メニュー・アクセス・予約・LINE」までの導線をひとつにまとめられ、ここから十分お問い合わせにつながります。迷う場合はトークで一言いただければ大丈夫です。',
    },
    {
    ...
    {
      q: '料金や納期を先に知りたいのですが？',
      a: `${RESPONSE_SLA} 金額の内訳・納期目安・制作の順序は料金ページの「ご料金の内訳」「制作の流れ」「よくある質問」にあります。`,
    },
  ];
